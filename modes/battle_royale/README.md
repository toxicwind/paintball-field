...
Free-for-all or squad-based. Safe zone shrinks over time. Players outside the zone take damage. The twist: the safe zone boundary pulses on your band LED. Players inside see objective contest status within the zone (red dots). Players outside get haptic storm warning, no display. Late-game becomes a objective control chess match.
...
| Final 3 players | All remaining players objective status revealed | Heartbeat | Rapid pulse |
