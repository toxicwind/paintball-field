...
Pure audio/haptic mode. OLED is off. No radar. Players rely entirely on haptic feedback to know when they've been hit and from what direction. The band vibrates in a pattern that encodes the direction of the hit based on objective proximity alerts. This is the most hardcore mode — pure instinct and sound.
