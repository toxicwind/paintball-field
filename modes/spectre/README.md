...
One player per team is designated the Spectre. The Spectre sees all objective states through walls permanently (red dots). Their team must protect them. If the enemy Spectre is eliminated, your team wins. This creates a "protect the VIP + assassinate their VIP" dual objective.
