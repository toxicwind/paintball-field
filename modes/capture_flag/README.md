...
Classic CTF reimagined with real-time positioning. The flag carrier is visible to the enemy team as a pulsing yellow dot on their radar. This creates a "hot potato" dynamic — the carrier must move fast, relay to teammates, or sacrifice themselves to reset visibility.
...
- Flag carrier position broadcast to enemy team at 2Hz (slower than normal 5Hz to add jitter)
- Flag relay requires both players stationary within 2m for 3s
- Dropped flag position broadcast to both teams until picked up
