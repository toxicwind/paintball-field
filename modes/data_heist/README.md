...
Asymmetric objective mode. Attackers must hack 3 terminals in sequence (A → B → C). Each terminal hack takes 15s and reveals the hacker's position to defenders as a pulsing purple dot. Defenders must protect all 3. The twist: hackers can "mask" their signal (hide dot for 5s) once per terminal, but masking disables their own radar. High-risk, high-reward stealth.
