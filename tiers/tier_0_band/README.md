...
|---------|-----|-------------------|
| Radar HUD | 32x32 OLED shows dots: green = teammates, red = enemies | Glance at wrist → see through walls |
...
- [Spectre](modes/spectre/README.md) — Assassination with wall vision
- [Hunter-Prey](modes/hunter_prey/README.md) — Pulse vision every 60s
